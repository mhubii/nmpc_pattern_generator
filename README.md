...
<figure>
  ...
  <figcpation>Fig. 1: From the visual terminal API: User controlled navigation in the physics simulation environment <a href="http://gazebosim.org/">Gazebo</a>.</figcaption>
</figure>
<br><br>
